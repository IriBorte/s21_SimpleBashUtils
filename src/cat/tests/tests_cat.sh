...
echo "Test flags -etsnb"
i=$((i+1))
cat -etsnb "$F1" > 1 && ./s21_cat -etsnb "$F1" > 2 && if diff -q 1 2;
...
echo "Test flags -etsnb two files"
i=$((i+1))
cat -etsnb "$F1" "$F2" > 1 && ./s21_cat -etsnb "$F1" "$F2" > 2 && if diff -q 1 2;
...
echo "Test flags -etsnb three files"
i=$((i+1))
cat -etsnb "$F1" "$F2" "$F3" > 1 && ./s21_cat -etsnb "$F1" "$F2" "$F3" > 2 && if diff -q 1 2;
